  ...
  ?>
      <nav class="navbar navbar-expand-lg mb-4 main-nav <?php echo $isStickyNavBar ?> bg-body-tertiary" data-bs-theme="<?php echo FM_THEME; ?>">
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
              ...
              echo '<div class="col-xs-6 col-sm-5 d-flex align-items-center">';
              ...
              echo '<input type="text" id="path-input" class="form-control form-control-sm d-none" value="'.fm_enc($path).'" onblur="disablePathEdit()" onkeyup="handlePathKey(event)" style="height: 31px;">';
              echo $editFile;
              echo '</div>';
              ?>
              ...
              function enablePathEdit() {
                  $('#path-breadcrumbs').addClass('d-none');
                  $('#path-input').removeClass('d-none').focus().select();
              }
